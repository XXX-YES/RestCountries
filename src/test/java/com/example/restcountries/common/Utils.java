...
////
        ...
        translations.put("br", "Finlândia");
        translations.put("pt", "Finlândia");
        translations.put("nl", "Finland");
        translations.put("hr", "Finska");
        translations.put("fa", "فنلاند");
        translations.put("de", "Finnland");
        translations.put("es", "Finlandia");
        translations.put("fr", "Finlande");
        translations.put("ja", "フィンランド");
        translations.put("it", "Finlandia");
        translations.put("hu", "Finnország");
